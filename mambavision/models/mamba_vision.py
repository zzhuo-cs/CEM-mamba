...
try:
    ...
    try:
        from timm.models.helpers import resolve_pretrained_cfg, update_default_cfg_and_kwargs as update_args
    except ImportError:
        # 如果以上都失败，创建虚拟函数
        def resolve_pretrained_cfg(model_name):
            return {}
        def update_args(cfg, kwargs, kwargs_filter=None):
            pass
from timm.models.vision_transformer import Mlp, PatchEmbed
from timm.models.layers import DropPath, trunc_normal_
from timm.models.registry import register_model
import torch.nn.functional as F
# Release packaging change: explicit backend selection, no shadow package.
from scan_backend import selective_scan_fn
...
def mamba_vision_T(pretrained=False, **kwargs):
    ...
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_T')
...
def mamba_vision_T2(pretrained=False, **kwargs):
    ...
    resolution = kwargs.pop("resolution", 224)
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_T2')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_S(pretrained=False, **kwargs):
    ...
    resolution = kwargs.pop("resolution", 224)
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_S')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_B(pretrained=False, **kwargs):
    ...
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_B')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_B_21k(pretrained=False, **kwargs):
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.3)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_B_21k')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_L(pretrained=False, **kwargs):
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.3)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_L')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_L_21k(pretrained=False, **kwargs):
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.3)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_L_21k')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_L2(pretrained=False, **kwargs):
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.3)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_L2')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_L2_512_21k(pretrained=False, **kwargs):
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.3)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_L2_512_21k')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_L3_256_21k(pretrained=False, **kwargs):
    ...
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_L3_256_21k')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
...
def mamba_vision_L3_512_21k(pretrained=False, **kwargs):
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.5)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    pretrained_cfg = _resolve_pretrained_cfg_dict('mamba_vision_L3_512_21k')
    update_args(pretrained_cfg, kwargs, kwargs_filter=None)
    model = MambaVision(depths=depths,
                        num_heads=num_heads,
                        window_size=window_size,
